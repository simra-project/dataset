...
All usage under the license and the extended rights described above are subject to the terms of use.
...
2. When you use the data you must not engage in any activities designed
  ...
  * to engage in any other activities that might deanonymize cyclists or otherwise infringe our app users' privacy rights.
